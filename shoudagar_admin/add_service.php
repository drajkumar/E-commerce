   ...
   $destination = '../uploads/';
    if(isset($_POST['save']) ){
       ...
       if(empty($productname)){
          ...
          $insert = $user->create_all('service', $data);
           if($insert == true){
             $result = $upload->getMessage();
           Session::flash('service_add', ' Service is Store your database');
           Redirect::to('add_service.php');

          }else{
           Session::flash('service_add_error', ' Service is not Store your database');
           Redirect::to('add_service.php');
          }
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              ...
              <div class="controls">
                <input type="text" name="productname" class="span11"
                 value="<?php if(isset($productname)){
                	echo $productname;}  ?>" placeholder="Service name" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" name="newprice"  value="<?php if(isset($newprice )){
                	echo $newprice ;}  ?>" class="span11" placeholder="Service price" />
              </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label">Service Img:</label>
              <div class="controls">
