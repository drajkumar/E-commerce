...
$packs_id = escape($_GET['service_id']); 
   ...
   $destination = '../uploads/';
    if(isset($_POST['save']) ){
       ...
       $image_name  = escape($_POST['image_name']);
          ...
          $user->update_all('service', 'service_id', $send_id, array(
           'title'   => $productname,
           ...
           'old_rate'           => $oldprice,
            ...
            Session::flash('service_edit', ' Service is Edit your database');
            Redirect::to('show_services.php');
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
           ...
           <?php 
              ...
              $data = $user->getData_one('service', 'service_id', $packs_id);
