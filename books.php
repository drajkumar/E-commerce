			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<?php
                             $subcata = $user->get_product_sub_cata_font('books');
							...
							?>
							<li class="p-t-4">
								<a href="products.php?mainc=books&subc=<?php echo $subcata[$key]['sub_chatagori'] ?>" class="s-text13 active1">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						<?php
                         $product = $user->getchat_product('product', '	product_main_chata', 'books');
