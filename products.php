			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<?php
                             $subcata = $user->get_product_sub_cata_font($mainc);
							...
							?>
							<li class="p-t-4">
								<a href="products.php?mainc=<?php echo $mainc;?>&subc=<?php echo $subcata[$key]['sub_chatagori'] ?>" class="s-text13 active1">
						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									Range: Tk<span id="value-lower"> 610</span> - <span id="value-upper">980</span>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						<?php
                         $product = $user->getchat_product_main_sub('product', 'product_main_chata', 'product_sub_chata', $mainc, $subc);
